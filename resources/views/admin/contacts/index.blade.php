                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                         ...
                         {{--}} <div class="input-group input-group-sm" style="width: 150px;">
                            ...
                            <a href="{{url("dashboard/contacts/create")}}" class="btn btn-sm btn-primary">
                                Add New
                            </a>
                        ...
                        @foreach ($contacts as $contact)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-primary "  href="{{url("dashboard/contacts/show/$contact->id")}}" >

                                        <i class="fas fa-eye"></i>

                                    </a>

                                    <a class="btn btn-sm btn-info "  href="{{url("dashboard/contacts/edit/$contact->id")}}" >

                                        <i class="fas fa-edit"></i>

                                    </a>

                                    <a class="btn btn-sm btn-danger" href="{{url("dashboard/contacts/delete/$contact->id")}}">
