  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Last News</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
              <li class="breadcrumb-item active">Last News</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                @include('admin.inc.errors')
                  ...
                  <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Last News</h3>
...
{{--                                <td >{{ $contact->address }}</td>--}}
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-info "  href="{{url("dashboard/news/edit/$news->id")}}" >
