                  ...
                  <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{url("dashboard/rate/create")}}" class="btn btn-sm btn-primary">
                                Add New
                            </a>
                      ...
                      <table class="table table-hover text-nowrap">
                        ...
                        @foreach ($rates as $rate)
                            ...
                            <tr>
                                ...
                                <td >{{ $rate->RateIp->user_id}}</td>
                                <td >{{ $rate->rate}}</td>
                                <td >{{ $rate->RateIp->ip}}</td>
...
{{--                                <td >{{ $contact->address }}</td>--}}
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-primary "  href="{{url("dashboard/rate/show/$rate->id")}}" >
                                    ...
                                    <a class="btn btn-sm btn-danger" href="{{url("dashboard/rate/delete/$rate->id")}}">
